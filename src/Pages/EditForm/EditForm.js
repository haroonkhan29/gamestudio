      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              ...
              const response = await fetch(`http://3.140.190.237:3002/employee/${id}`, {
                method: 'PUT',
                body: formData,
              });
      ...
      <div className="editFormWrapper">
        ...
        <label>
          ...
          <div className="current-profile-pic">
             {profilePicFile && (
              <img
              src={profilePicFile ? URL.createObjectURL(profilePicFile) : `http://3.140.190.237:3002/${currentProfilePicPath}`}              
                alt="New Profile Pic"
