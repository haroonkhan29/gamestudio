      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              ...
              const response = await fetch(`http://35.184.241.89:3000/employee/${id}`, {
                method: 'PUT',
                body: formData,
              });
      ...
      <div className="editFormWrapper">
        ...
        <label>
          ...
          <div className="current-profile-pic">
             {profilePicFile && (
              <img
              src={profilePicFile ? URL.createObjectURL(profilePicFile) : `http://35.184.241.89:3000/${currentProfilePicPath}`}              
                alt="New Profile Pic"
